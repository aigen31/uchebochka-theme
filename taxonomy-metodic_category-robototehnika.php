        ...
        <?php if ($materials_query->have_posts()) : ?>
          ...
          ?>
            ...
            <article
              ...
              <?php else : ?>
                <div class="w-full aspect-square bg-[#F3F4F6] flex items-center justify-center text-[#6B7280]">
                  Нет изображения
                </div>
              <?php endif; ?>
