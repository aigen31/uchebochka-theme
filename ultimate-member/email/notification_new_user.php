...
<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin:40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666;">
	...
	<div style="padding: 0 30px 30px 30px;border-bottom: 3px solid #eeeeee;">
		...
		<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px;">{display_name} только что создал(-а) аккаунт на {site_name}.</div>

		<div style="padding: 10px 0 50px 0;text-align: center;">Чтобы посмотреть профиль, нажмите здесь: <a href="{user_profile_link}" style="color: #3ba1da;text-decoration: none;">{user_profile_link}</a></div>
