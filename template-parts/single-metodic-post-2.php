...
$editorContent = get_the_content();
$is_free = get_post_meta($post_id,'free_material')[0] == "1" ? true : false;
$price =  floatval(get_post_meta($post_id,'price')[0]);
$yandexDiskLink = get_post_meta($post_id,'metodic_file_url')[0];
get_header(); ?>
</div>
...
<section class="section-materials">
    <div class="container d-md-flex">
        ...
        <div class="section-materials__materials add-material">
            <h1>Редактирование методической разработки</h1>
            ...
            <form id="save-metodic-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_title" id="post_title" required value="<?php echo get_the_title();?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php wp_editor($editorContent, 'post_content', [
                        'tinymce' => [
                ...
                <div class="form-group">
                    <div class="row post_categories__wrapper">
                        <?php
                        $array_terms = [];
                        $terms = get_the_terms($post_id, 'metodic_category');
                        ...
                        ?>
                            <div class="col-md-4 col-12">
                                ...
                                get_template_part('template-parts/terms', 'list', array_merge($args, [
                                    ...
                                    'slug' => $data['slug'],
                                    'current_categories' => array_column($array_terms,'slug')
                                ]));
                                ?>
                            </div>
                        <?php
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-in">
                        ...
                        <input type="text" name="yandex_disk" value="<? echo $yandexDiskLink;?>" placeholder="https://disk.yandex.ru" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="um-field um-custom-field cf-frontend-wrap">
                        <div class="cf-group">
                            ...
                            <?foreach($rutube_ids as $url):?>
                            <div class="rutube-wrapper">
                                <div class="cf-item">
                                    <div class="cf-item__fields">
                                        <label>Ссылка на видео с Rutube
                                            <input type="text" maxlength="255" value="<?echo $url?>" name="rutube_id[]" placeholder="https://rutube.ru/video/ваш_id_видео">
                                        </label>
                                    </div>
                        ...
                        <div class="cf-group">
                            ...
                            <?foreach($vk_video_ids as $url):?>
                            <div class="vk-video-wrapper">
                                <div class="cf-item">
                                    <div class="cf-item__fields">
                                        <label>Ссылка VK Видео
                                            <input type="text" maxlength="255" value="<?php echo $url?>" name="vk_video_id[]" placeholder="https://vkvideo.ru/ваш_id_видео">
                                        </label>
                                    </div>
                                    <div class="cf-item__actions">
                                        <button type="button" class="btn btn--accent cf-up">↑</button>
                    ...
                    <div class="form-group-in">
                        <div class="d-flex">
                            <label class="checkbox-label">
                                <input type="checkbox" id="free_material" name="free_material" <?php echo $is_free ? 'checked': ''?>>
                ...
                <div class="form-group">
                    ...
                    <p>
                        Минимальная цена товара - 50 рублей.
                    </p>

                    <div class="price-row row">
                        <div class="col-md-6 col-12">
                            <input type="text" name="price" value="<?php echo $price ?>" placeholder="руб." id="priceInput">
              ...
              Помните, что на объем продаж влияет качество карточки товара; стоимость; содержание и качество превью материала"></div>
                    ...
                    <div class="d-flex">
                        <button class="btn btn-send" id="addMaterialButton">Сохранить</button>
                        <div class="agree">
                            <label>
