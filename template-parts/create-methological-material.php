            ...
            <div class="section-materials__materials add-material">
                ...
                <form action="">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-12">
                                <div class="item">
                                    ...
                                    <div class="inputs">
                                        <label><input type="checkbox" name="predmet[]" value=""><span></span>UX/UI-дизайн</label>
                                        <label><input type="checkbox" name="predmet[]" value=""><span></span>Адаптивная физическая культура и спорт</label>
                                        <label><input type="checkbox" name="predmet[]" value=""><span></span>Администрирование баз данных</label>

                                        <div class="inputs-hid">
                                            <label><input type="checkbox" name="predmet[]" value=""><span></span>Алгебра</label>
                                            <label><input type="checkbox" name="predmet[]" value=""><span></span>Английский язык</label>
                                            <label><input type="checkbox" name="predmet[]" value=""><span></span>Дизайн</label>
                                        </div>
                                        <div class="but">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="item">
                                    ...
                                    <div class="inputs">
                                        <label><input type="checkbox" name="cat[]" value=""><span></span>UX/UI-дизайн</label>
                                        <label><input type="checkbox" name="cat[]" value=""><span></span>Адаптивная физическая культура и спорт</label>
                                        <label><input type="checkbox" name="cat[]" value=""><span></span>Администрирование баз данных</label>

                                        <div class="inputs-hid">
                                            <label><input type="checkbox" name="cat[]" value=""><span></span>Алгебра</label>
                                            <label><input type="checkbox" name="cat[]" value=""><span></span>Английский язык</label>
                                            <label><input type="checkbox" name="cat[]" value=""><span></span>Дизайн</label>
                                        </div>
                                        <div class="but">
                                            <button type="button">Показать ещё</button>
                                        </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="item">
                                    ...
                                    <div class="inputs">
                                        <label><input type="checkbox" name="tip[]" value=""><span></span>UX/UI-дизайн</label>
                                        <label><input type="checkbox" name="tip[]" value=""><span></span>Адаптивная физическая культура и спорт</label>
                                        <label><input type="checkbox" name="tip[]" value=""><span></span>Администрирование баз данных</label>

                                        <div class="inputs-hid">
                                            <label><input type="checkbox" name="tip[]" value=""><span></span>Алгебра</label>
                                            <label><input type="checkbox" name="tip[]" value=""><span></span>Английский язык</label>
                                            <label><input type="checkbox" name="tip[]" value=""><span></span>Дизайн</label>
                                        </div>
                                        <div class="but">
                                            <button type="button">Показать ещё</button>
                                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group-in">
                            ...
                            <div class="file-upload-area" data-input-name="doc[]">
                                ...
                                <div class="file-names"></div>
                                <input type="file" name="doc[]" class="file-input-hidden" accept=".doc,.docx,.odt" multiple>
                            </div>
                        </div>
                        ...
                        <div class="form-group-in">
                            ...
                            <div class="file-upload-area" data-input-name="ppt[]">
                                ...
                                <div class="file-names"></div>
                                <input type="file" name="ppt[]" class="file-input-hidden" accept=".pptx,.ppt,.odp" multiple>
                            </div>
                        </div>
                        ...
                        <div class="form-group-in">
                            ...
                            <div class="file-upload-area" data-input-name="pdf[]">
                                ...
                                <div class="file-names"></div>
                                <input type="file" name="pdf[]" class="file-input-hidden" accept=".pdf" multiple>
                            </div>
                        </div>

                        <div class="form-group-in">
                            <div class="subtitle">Ссылка на Яндекс Диск</div>
                            <input type="text" name="disk" value="" placeholder="https://disk.yandex.ru" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group-in">
                            <p>Ссылка на Rutube</p>
                            <input type="text" name="rutube" value="" placeholder="https://rutube.ru/video/ваш_id_видео" class="form-control">
                        </div>
                        <div class="form-group-in">
              ...
              Помните, что на объем продаж влияет качество карточки товара; стоимость; содержание и качество превью материала"></div>
                        ...
                        <div class="d-flex">
                            <button class="btn btn-send">Добавить</button>
                            <div class="agree">
                                <label>
